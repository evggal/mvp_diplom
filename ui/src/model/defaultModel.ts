  ...
  return {
    ...
    config: {
      ...
      nodes: [
        {
          node_id: "ARRIVAL_GEN",
          name: "Arrival Generator",
          node_type: "generator",
          open_time: 0,
          close_time: null,
          schedule: [{ open_time: 0, close_time: null }],
          channels: 1,
        ...
        },
        {
          ...
          routes: [
            {
              target_node_id: "TH_REG",
              edge_id: "edge_b1_th_reg",
              probability: 1,
            },
          ],
        },
        {
          ...
          routes: [
            {
              target_node_id: "P1",
              edge_id: "edge_th_reg_p1",
              probability: 0.3301435406698565,
            },
            {
              target_node_id: "P2",
              edge_id: "edge_th_reg_p2",
              probability: 0.3827751196172249,
            },
            {
              target_node_id: "P3",
              edge_id: "edge_th_reg_p3",
              probability: 0.23923444976076555,
            },
            {
              target_node_id: "P4",
              edge_id: "edge_th_reg_p4",
              probability: 0.04784688995215311,
            },
          ],
        },
        {
          ...
          close_time: 50,
          schedule: [
            { open_time: 10, close_time: 50 },
            { open_time: 95, close_time: 135 },
          ],
          channels: 5,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
        ...
        },
        {
          ...
          close_time: 80,
          schedule: [
            { open_time: 20, close_time: 80 },
            { open_time: 110, close_time: 165 },
          ],
          channels: 7,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
        ...
        },
        {
          ...
          close_time: 60,
          schedule: [
            { open_time: 5, close_time: 60 },
            { open_time: 75, close_time: 165 },
          ],
          channels: 5,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
        ...
        },
        {
          ...
          open_time: 75,
          close_time: 165,
          schedule: [{ open_time: 75, close_time: 165 }],
          channels: 3,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
            mean: 4.0,
        ...
        },
        {
          ...
          routes: [
            {
              target_node_id: "TH_BOARD",
              edge_id: "edge_b2_th_board",
              probability: 1,
            },
          ],
        },
        ...
        },
        {
          ...
          routes: [
            {
              target_node_id: "P5",
              edge_id: "edge_th_board_p5",
              probability: 0.5,
            },
            {
              target_node_id: "P6",
              edge_id: "edge_th_board_p6",
              probability: 0.5,
            },
          ],
        },
        {
          ...
          close_time: 70,
          schedule: [
            { open_time: 10, close_time: 70 },
            { open_time: 100, close_time: 165 },
          ],
          channels: 1,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
        ...
        },
        {
          ...
          close_time: 120,
          schedule: [
            { open_time: 60, close_time: 120 },
            { open_time: 135, close_time: 175 },
          ],
          channels: 1,
          service_distribution: CreateDistribution({
            distribution_type: "normal",
